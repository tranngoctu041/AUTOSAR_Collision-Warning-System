...
Std_ReturnType sys_init(void)
{
    ...
    IP_SCG->SOSCCFG = 0x00000024u;  /* SCG_SOSCCFG: RANGE=2, EREFS=1 */
...
#endif
#if defined(S32K144)||defined(S32K144W)||defined(S32K146)|| defined(S32K148)    
