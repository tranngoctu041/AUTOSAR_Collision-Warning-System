...
==================================================================================================*/
#define SCHM_SENT_AR_RELEASE_MAJOR_VERSION_C     4
#define SCHM_SENT_AR_RELEASE_MINOR_VERSION_C     4
#define SCHM_SENT_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_SENT_SW_MAJOR_VERSION_C             1
#define SCHM_SENT_SW_MINOR_VERSION_C             0
#define SCHM_SENT_SW_PATCH_VERSION_C             1
...
* 
*/
uint32 Sent_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 Sent_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#elif  (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
...
#ifdef MCAL_PLATFORM_S12
    #define Sent_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define Sent_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
