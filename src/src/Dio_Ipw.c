...
=================================================================================================*/
#define DIO_VENDOR_ID_IPW_C                    43
#define DIO_AR_RELEASE_MAJOR_VERSION_IPW_C     4
#define DIO_AR_RELEASE_MINOR_VERSION_IPW_C     4
#define DIO_AR_RELEASE_REVISION_VERSION_IPW_C  0
#define DIO_SW_MAJOR_VERSION_IPW_C             1
#define DIO_SW_MINOR_VERSION_IPW_C             0
#define DIO_SW_PATCH_VERSION_IPW_C             0
/*=================================================================================================
*                                     FILE VERSION CHECKS
=================================================================================================*/
/* Check if Dio_Ipw source file and Dio_Ipw header file are of the same vendor */
#if (DIO_VENDOR_ID_IPW_C != DIO_VENDOR_ID_IPW_H)
...
#if ((DIO_AR_RELEASE_MAJOR_VERSION_IPW_C    != DIO_AR_RELEASE_MAJOR_VERSION_IPW_H) || \
     (DIO_AR_RELEASE_MINOR_VERSION_IPW_C    != DIO_AR_RELEASE_MINOR_VERSION_IPW_H) || \
     (DIO_AR_RELEASE_REVISION_VERSION_IPW_C != DIO_AR_RELEASE_REVISION_VERSION_IPW_H) \
    )
...
#if ((DIO_SW_MAJOR_VERSION_IPW_C != DIO_SW_MAJOR_VERSION_IPW_H) || \
     (DIO_SW_MINOR_VERSION_IPW_C != DIO_SW_MINOR_VERSION_IPW_H) || \
     (DIO_SW_PATCH_VERSION_IPW_C != DIO_SW_PATCH_VERSION_IPW_H)    \
    )
...
#if (DIO_VENDOR_ID_IPW_C != DIO_VENDOR_ID_CFG_H)
...
#if ((DIO_AR_RELEASE_MAJOR_VERSION_IPW_C    != DIO_AR_RELEASE_MAJOR_VERSION_CFG_H) || \
     (DIO_AR_RELEASE_MINOR_VERSION_IPW_C    != DIO_AR_RELEASE_MINOR_VERSION_CFG_H) || \
     (DIO_AR_RELEASE_REVISION_VERSION_IPW_C != DIO_AR_RELEASE_REVISION_VERSION_CFG_H) \
    )
...
#if ((DIO_SW_MAJOR_VERSION_IPW_C != DIO_SW_MAJOR_VERSION_CFG_H) || \
     (DIO_SW_MINOR_VERSION_IPW_C != DIO_SW_MINOR_VERSION_CFG_H) || \
     (DIO_SW_PATCH_VERSION_IPW_C != DIO_SW_PATCH_VERSION_CFG_H)    \
    )
...
#if (DIO_VENDOR_ID_IPW_C != GPIO_DIO_IP_VENDOR_ID_CFG_H)
...
#if ((DIO_AR_RELEASE_MAJOR_VERSION_IPW_C    != GPIO_DIO_IP_AR_RELEASE_MAJOR_VERSION_CFG_H) || \
     (DIO_AR_RELEASE_MINOR_VERSION_IPW_C    != GPIO_DIO_IP_AR_RELEASE_MINOR_VERSION_CFG_H) || \
     (DIO_AR_RELEASE_REVISION_VERSION_IPW_C != GPIO_DIO_IP_AR_RELEASE_REVISION_VERSION_CFG_H) \
    )
...
#if ((DIO_SW_MAJOR_VERSION_IPW_C != GPIO_DIO_IP_SW_MAJOR_VERSION_CFG_H) || \
     (DIO_SW_MINOR_VERSION_IPW_C != GPIO_DIO_IP_SW_MINOR_VERSION_CFG_H) || \
     (DIO_SW_PATCH_VERSION_IPW_C != GPIO_DIO_IP_SW_PATCH_VERSION_CFG_H)    \
    )
