...
#define Power_Ip_SIM_AR_RELEASE_MINOR_VERSION_C       4
#define Power_Ip_SIM_AR_RELEASE_REVISION_VERSION_C    0
#define Power_Ip_SIM_SW_MAJOR_VERSION_C               1
 ...
 *
 */
void Power_Ip_SIM_SRAMRetentionConfig(Power_Ip_SRAMRetenConfigType eSRAMRetenConfig)
{
    uint32 u32TempValue;
    ...
    u32TempValue = IP_SIM->CHIPCTL;
    u32TempValue &= ~(SIM_CHIPCTL_SRAML_RETEN_MASK | SIM_CHIPCTL_SRAMU_RETEN_MASK);
    u32TempValue |= (uint32)eSRAMRetenConfig;
    IP_SIM->CHIPCTL = u32TempValue;
