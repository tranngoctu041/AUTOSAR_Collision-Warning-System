...
#define SCHM_WDG_SW_PATCH_VERSION_C             1
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_00(void)
{
    ...
    if(0UL == reentry_guard_WDG_EXCLUSIVE_AREA_00[u32CoreId])
    {
        ...
        msr_WDG_EXCLUSIVE_AREA_00[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_00[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_00[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_01(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_01[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_01[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_01[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_02(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_02[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_02[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_02[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_03(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_03[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_03[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_03[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_04(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_04[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_04[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_04[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_05(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_05[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_05[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_05[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_06(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_06[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_06[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_06[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_07(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_07[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_07[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_07[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_08(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_08[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_08[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_08[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_09(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_09[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_09[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_09[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_10(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_10[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_10[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_10[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_11(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_11[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_11[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_11[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_12(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_12[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_12[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_12[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_13(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_13[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_13[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_13[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_14(void)
{
    ...
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr_WDG_EXCLUSIVE_AREA_14[u32CoreId] = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        msr_WDG_EXCLUSIVE_AREA_14[u32CoreId] = Wdg_schm_read_msr();  /*read MSR (to store interrupts state)*/
#endif /* MCAL_ENABLE_USER_MODE_SUPPORT */
        if (ISR_ON(msr_WDG_EXCLUSIVE_AREA_14[u32CoreId])) /*if MSR[EE] = 0, skip calling Suspend/Resume AllInterrupts*/
        {
            OsIf_SuspendAllInterrupts();
#ifdef _ARM_DS5_C_S32K1XX_
            ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
