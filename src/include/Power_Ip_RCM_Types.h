...
#define POWER_IP_RCM_TYPES_AR_RELEASE_MINOR_VERSION        4
#define POWER_IP_RCM_TYPES_AR_RELEASE_REVISION_VERSION     0
#define POWER_IP_RCM_TYPES_SW_MAJOR_VERSION                1
...
typedef struct
{
    uint32  u32ResetPinControlConfig;
    uint32  u32ResetInterruptEnableConfig;
