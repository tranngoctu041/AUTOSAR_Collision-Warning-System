...
==================================================================================================*/
/* @violates @ref Icu_MemMap_h_REF_3 #include statements in a file should
...
*/
/** @violates @ref Icu_MemMap_h_REF_2 version is required. */
...
/** @violates @ref Icu_MemMap_h_REF_2 version is required. */
#define ICU_MEMMAP_SW_MAJOR_VERSION             1
/** @violates @ref Icu_MemMap_h_REF_2 version is required. */
...
/**************************************** ICU *******************************/
    ...
    /**
    * @file Icu_MemMap.h
    * @violates @ref Icu_MemMap_h_REF_1 MISRA 2012 Required Rule 19.6, use of '#undef' is discouraged
    */
