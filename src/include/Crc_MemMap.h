...
==================================================================================================*/
/* @violates @ref Crc_MemMap_h_REF_3 #include statements in a file should
...
*/
/** @violates @ref Crc_MemMap_h_REF_2 version is required. */
...
/** @violates @ref Crc_MemMap_h_REF_2 version is required. */
#define CRC_MEMMAP_SW_MAJOR_VERSION             1
/** @violates @ref Crc_MemMap_h_REF_2 version is required. */
...
/**************************************** CRC *******************************/
    ...
    /**
    * @file Crc_MemMap.h
    * @violates @ref Crc_MemMap_h_REF_1 MISRA 2012 Required Rule 19.6, use of '#undef' is discouraged
    */
