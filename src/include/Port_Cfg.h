...
#if (PORT_VENDOR_ID_CFG_H != PORT_VENDOR_ID_PBCFG_H)
...
#if ((PORT_AR_RELEASE_MAJOR_VERSION_CFG_H != PORT_AR_RELEASE_MAJOR_VERSION_PBCFG_H) ||    \
     (PORT_AR_RELEASE_MINOR_VERSION_CFG_H != PORT_AR_RELEASE_MINOR_VERSION_PBCFG_H) ||    \
     (PORT_AR_RELEASE_REVISION_VERSION_CFG_H != PORT_AR_RELEASE_REVISION_VERSION_PBCFG_H) \
    )
...
#if ((PORT_SW_MAJOR_VERSION_CFG_H != PORT_SW_MAJOR_VERSION_PBCFG_H) ||  \
     (PORT_SW_MINOR_VERSION_CFG_H != PORT_SW_MINOR_VERSION_PBCFG_H) ||  \
     (PORT_SW_PATCH_VERSION_CFG_H != PORT_SW_PATCH_VERSION_PBCFG_H)     \
    )
