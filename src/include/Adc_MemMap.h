...
==================================================================================================*/
/* @violates @ref Adc_MemMap_h_REF_3 #include statements in a file should
...
*/
/** @violates @ref Adc_MemMap_h_REF_2 version is required. */
...
/**************************************** ADC *******************************/
    ...
    /**
    * @file Adc_MemMap.h
    * @violates @ref Adc_MemMap_h_REF_1 MISRA 2012 Required Rule 19.6, use of '#undef' is discouraged
    */
