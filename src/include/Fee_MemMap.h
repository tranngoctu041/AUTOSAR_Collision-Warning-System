...
==================================================================================================*/
/* @violates @ref Fee_MemMap_h_REF_3 #include statements in a file should
...
*/
/** @violates @ref Fee_MemMap_h_REF_2 version is required. */
...
/** @violates @ref Fee_MemMap_h_REF_2 version is required. */
#define FEE_MEMMAP_SW_MAJOR_VERSION             1
/** @violates @ref Fee_MemMap_h_REF_2 version is required. */
...
/**************************************** FEE *******************************/
    ...
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2012 Required Rule 19.6, use of '#undef' is discouraged
    */
