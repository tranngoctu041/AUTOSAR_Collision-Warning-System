...
* @violates @ref StdRegMacros_h_REF_1 MISRA 2012 Advisory Rule 19.7, A function should be used in
...
*/
/* @violates @ref RegLockMacros_h_REF_1 MISRA 2012 Advisory Rule 4.9, Function-like macro defined.*/
