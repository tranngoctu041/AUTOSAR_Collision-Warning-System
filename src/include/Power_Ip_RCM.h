...
#define POWER_IP_RCM_AR_RELEASE_MINOR_VERSION        4
#define POWER_IP_RCM_AR_RELEASE_REVISION_VERSION     0
#define POWER_IP_RCM_SW_MAJOR_VERSION                1
...
#define Call_Power_Ip_RCM_SystemResetIsrConfig() \
    OsIf_Trusted_Call(Power_Ip_RCM_SystemResetIsrConfig)
  #else
...
#define Call_Power_Ip_RCM_RestoreSystemResetIsrConfig(u32SystemResetIsrConfig) \
    OsIf_Trusted_Call1param(Power_Ip_RCM_RestoreSystemResetIsrConfig,(u32SystemResetIsrConfig))
  #else

#define  Call_Power_Ip_RCM_RestoreSystemResetIsrConfig(u32SystemResetIsrConfig) \
    Power_Ip_RCM_RestoreSystemResetIsrConfig(u32SystemResetIsrConfig)
  #endif
#endif /* POWER_IP_ENABLE_USER_MODE_SUPPORT */
