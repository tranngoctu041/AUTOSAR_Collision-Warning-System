...
==================================================================================================*/
/* @violates @ref Ecum_MemMap_h_REF_3 #include statements in a file should
...
*/
/** @violates @ref Ecum_MemMap_h_REF_2 version is required. */
...
/**************************************** ECUM *******************************/
    ...
    /**
    * @file Ecum_MemMap.h
    * @violates @ref Ecum_MemMap_h_REF_1 MISRA 2012 Required Rule 19.6, use of '#undef' is discouraged
    */
