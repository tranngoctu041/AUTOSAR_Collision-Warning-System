...
*
* @section IpVersionMacros_h_REF_1
...
#define IPVERSIONMACROS_SW_MAJOR_VERSION             1
...
/* @violates @ref IpVersionMacros_h_REF_1 MISRA 2012 Advisory Rule 4.9, Function-like macro defined.*/
