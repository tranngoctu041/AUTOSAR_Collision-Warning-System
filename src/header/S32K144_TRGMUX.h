...
/*!
 * @file S32K144_TRGMUX.h
 * @version 1.0
 * @date 2021-02-23
 * @brief Peripheral Access Layer for S32K144_TRGMUX
 *
...
#if !defined(S32K144_TRGMUX_H_)  /* Check if memory map has not been already included */
#define S32K144_TRGMUX_H_
...
#endif  /* #if !defined(S32K144_TRGMUX_H_) */
