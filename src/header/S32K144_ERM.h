 ...
 * @version 1.0
 * @date 2021-02-23
 * @brief Peripheral Access Layer for S32K144_ERM
 *
...
#if !defined(S32K144_ERM_H_)  /* Check if memory map has not been already included */
#define S32K144_ERM_H_
...
#endif  /* #if !defined(S32K144_ERM_H_) */
