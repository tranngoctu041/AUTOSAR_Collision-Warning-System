 ...
 * @version 1.0
 * @date 2021-02-23
 * @brief Peripheral Access Layer for S32K144_GPIO
 *
...
#if !defined(S32K144_GPIO_H_)  /* Check if memory map has not been already included */
...
#endif  /* #if !defined(S32K144_GPIO_H_) */
