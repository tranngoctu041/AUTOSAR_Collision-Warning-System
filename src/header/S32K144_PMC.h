 ...
 * @version 1.0
 * @date 2021-02-23
 * @brief Peripheral Access Layer for S32K144_PMC
 *
...
#if !defined(S32K144_PMC_H_)  /* Check if memory map has not been already included */
#define S32K144_PMC_H_
...
#endif  /* #if !defined(S32K144_PMC_H_) */
